...
//    printf("%d\n",lg0tst);
    ...
    for(int j=0;j<8;j++)
        {
            printf("The number of elements in D larger than 1e-%d is %d\n",j,larger[j]);
        }
...
//    printf("%d\n",lg0tst);
    ...
    for(size_t i=0;i<nbf*nbf;i++)
        {
            for(int j=0;j<8;j++)
            {
                if(fabs(DC_mat[i])>maxv/pow(10,j))
                {
                    larger[j]+=1;
                }
            }
    ...
    for(int j=0;j<8;j++)
        {
            printf("The number of elements in DC larger than 1e-%d is %d\n",j,larger[j]);
        }
