...
struct TinyDFT_struct 
{
    ...
    // Except Cocc_mat is nbf-by-n_occ, Cvir_mat is nbf-by-n_vir, all other matrices are nbf-by-nbf
    // The array orbitenergy_array is energy of all the orbitals, The first n_occ are occupied orbitals and the last n_vir are virtual orbitals
    ...
    double *DC_mat;         // Added: Density complimentary matrix
    double *Cocc_mat;       // Factor of density matrix
    double *Cvir_mat;       // Added: Factor of density complimentary matrix
    double *orbitenergy_array; // Added: Energy of orbitals in ascending order
